...
|Use Guest VM
|You want to attach the virtual disk to the VM that you right-clicked
before you started the wizard, and then select the credential for the VM.
...
|a{x,y}
|At least x number of instances of the character a ,and, at most, y
number.
|\

...
. link:#verify-registration-succeeded[Verify that the registration succeeded].
...
+
.. Re-enter the correct vCenter username (`domain\username`) and password.
...
+
For more information, see link:scpivs44_deployment_planning_and_requirements.html[Deployment planning and requirements for the SCV].

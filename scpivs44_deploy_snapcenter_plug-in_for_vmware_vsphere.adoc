...
.. #In *Create SnapCenter Plug-in for VMware vSphere credentials*, enter the local credentials.#
+
#In the *Username* field, enter the local username in the format `domain\username.local`.#
#In the *Password* field, special characters are not supported.#
//
// Burt 1366351 Mar 2021 Ronya
//
+
[IMPORTANT]

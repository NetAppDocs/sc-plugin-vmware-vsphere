...
* #To protect VMs on vVol datastores, you must first deploy ONTAP Tools for VMware vSphere (OTV). OTV provisions and configures storage on ONTAP and on the VMware web client.#

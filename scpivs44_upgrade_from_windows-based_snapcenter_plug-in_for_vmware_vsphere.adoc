...
+
link:scpivs44_post_deployment_required_operations_and_issues.html[Post deployment issues and required operations]

. Migrate the Windows-based VMware backup metadata.
+
See the migration section in the https://mysupport.netapp.com/documentation/productlibrary/index.html?productID=63240[Data Protection Guide for SnapCenter Plug-in for VMware vSphere^].

...
|Primary backups
|YNFS environments: ONTAP Single File SnapRestore
VMFS environments: Clone and mount with Storage VMotion
|Deleted VMs and VMDKs
|Secondary backups
...
|#NFS environments: ONTAP Single File SnapRestore#
#VMFS environments: Not supported#
|#vVol VMs#
|#Crash-consistent secondary backups#
|#NFS environments: Not supported#
#VMFS environments: SnapMirror Restore#
|#FlexGroup VMs#
|#Primary backups#
|#NFS environments: ONTAP Single File SnapRestore#
#VMFS environments: Not supported#
|#FlexGroup VMs#
|#Secondary backups#
|#NFS environments: ONTAP Single File Restore#
#VMFS environments: Not supported#
|===

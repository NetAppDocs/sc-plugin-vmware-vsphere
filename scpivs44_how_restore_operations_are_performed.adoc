...
To perform restore operations using Amazon FSx for NetApp ONTAP storage systems as secondary storage with the SnapCenter Plug-in for VMware vSphere, you must enable support for these storage systems. 

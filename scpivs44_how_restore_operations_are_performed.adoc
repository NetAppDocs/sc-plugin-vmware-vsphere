...
= How the SnapCenter Plug-in for VMware vSphere performs restore operations
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
[NOTE]
Support for Amazon FSx for NetApp ONTAP storage systems is available beginning with the SCV 6.2 release.

// VMDP-6249 - jani added this note

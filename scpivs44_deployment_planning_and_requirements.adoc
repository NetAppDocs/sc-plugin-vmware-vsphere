...
+
For the latest information about supported versions of ONTAP Tools, see the https://mysupport.netapp.com/matrix/imt.jsp?components=91324;&solution=1517&isHWU&src=IMT[NetApp Interoperability Matrix Tool^].
...
|9.8P1 and later
SnapCenter Plug-in for VMware vSphere uses this to manage vVol datastores (VMware virtual volumes).

9.10 and later also supports the Federal Information Processing Standard (FIPS).

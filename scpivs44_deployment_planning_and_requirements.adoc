...
* #To protect vVols VMs (VMware virtual volumes), you must first deploy ONTAP Tools for VMware (OTV) to provision and configure storage for vVols on ONTAP and on the VMware web client before you can use SnapCenter Plug-in for VMware vSphere to protect the data.#
+

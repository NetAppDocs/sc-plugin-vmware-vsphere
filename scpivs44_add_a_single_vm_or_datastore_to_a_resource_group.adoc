...
= Add a single VM or datastore to a resource group in the SnapCenter Plug-in for VMware vSphere
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
. In the vSphere client user interface, select *Menu* in the toolbar, and navigate to the VM or datastore that you want to add.

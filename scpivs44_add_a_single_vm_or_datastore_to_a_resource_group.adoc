...
. In the left navigator pane, right-click on the VM or datastore, select *SnapCenter Plug-in for VMware vSphere* from the drop-down list, and then select *Add To Resource Group* from the secondary drop-down list.
+

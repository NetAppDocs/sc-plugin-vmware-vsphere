...
[.lead]
You can manually mount a backup if you want to access the files in the backup.
...
. On the *Mount Datastore* page, select a backup and a backup location, and then click *Finish*.

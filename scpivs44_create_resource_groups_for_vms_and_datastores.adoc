...
* vCenter tag
+
All VMs and Datastores, excluding vVol Datastores, that have the specified vCenter tag. 
// updated for 5.0
...
* Tags - Tag based VM protection is supported for Vvol, NFS, and VMFS Datastores.
Tag based datastore protection is supported only for NFS and VMFS datastores. In the list box you must enter the tag.
// updated for 5.0
...
[NOTE]
Spanning datastores are supported for VMFS and NFS tag based protection.
// Updated to 5.0

...
+
#Any combination of traditional VMs, traditional SAN datastores, and traditional NAS datastores. vVol VMs are not supported in combination with traditional VMs.#

* #Flexgroup datastores#
+
#One FlexGroup datastore. Spanning datastores are not supported. FlexGroup datastores cannot be combined with traditional VMs or datastores.#
...
* #vVol VMs#
+
#One or more vVol VMs. vVol VMs are not supported in combination with traditional VMs or datastores.#

* #vVol VMs with a tag#
+
#All vVol VMs with a single, specified VMware tag in a single vCenter. Other entities with tags, such as Vapps, or VMs with the same tag in a different vCenter, are not supported.#
// Burt 1422442 23Nov2021 Ronya
// Burt 1428392 24Nov2021 Ronya

* #vVol VMs in a folder#
+
#All vVols in a single, specified vVol folder.#

For all resource groups:

[IMPORTANT]
#If a resource group contains a mix of vVol VMs and traditional VMs, SnapCenter Plug-in for VMware vSphere backs up the vVol VMs and skips the traditional VMs.#
// Burt 1434168 3Nov2021, burt 1428684 24Nov2021 Ronya

[IMPORTANT]
#If you are using VMware vSphere Cluster Service (vCLS), you should not include VMs managed by vCLS in SnapCenter VMware plug-in resource groups.#
...
#ONTAP Tools for VMware (OTV) must be deployed before you create a resource group that contains vVol VMs.#
...
+
#Spanning VMs and vVOLs are not supported for FlexGroup datastores.#

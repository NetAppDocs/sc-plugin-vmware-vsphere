...
* #vVol VMs with a tag#
+
#All vVol VMs with a single, specified VMware tag.#
...
[NOTE]
#If a resource group contains vVol VMs and traditional VMs, SnapCenter Plug-in for VMware vSphere backs up the vVol VMs and skips the traditional VMs.#
// Burt 1434168 3Nov2021 Ronya
...
* #Virtual Machines (individual traditional or vVol VMs; in the popup field you must navigate to the datastore that contains the VMs or vVol VMs)#

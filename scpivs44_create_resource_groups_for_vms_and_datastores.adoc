...
+
#Any combination of traditional VMs, traditional SAN datastores, and traditional NAS datastores. VSAN and vVol datastores not supported.#

* #Flexgroup datastores#
+
#One FlexGroup datastore. Spanning datastores are not supported.#
...
* #Tags (all vVol VMs with a single, specified VMware tag; in the popup field you must enter the tag)#

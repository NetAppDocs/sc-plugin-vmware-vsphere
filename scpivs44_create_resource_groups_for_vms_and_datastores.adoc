...
+
If you are running ONTAP 9.8, then after a switchback, you must restart the SnapCenter VMware plug-in service and resynchronize the SnapMirror relationships before you backup resource groups in MetroCluster environments. This issue is fixed in ONTAP 9.9.

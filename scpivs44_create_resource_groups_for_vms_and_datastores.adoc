...
Resource groups can contain any combination of VMs and datastores. A resource group can also contain one FlexGroup volume or one or more FlexVol volumes, but not both.
...
|If you want the suffix “_recent” added to the latest Snapshot copy, then check this box.

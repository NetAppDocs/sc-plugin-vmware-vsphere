...
| Update | Description
a|
https://docs.netapp.com/us-en/sc-plugin-vmware-vsphere/scpivs44_concepts_overview.html[NVMe over TCP protocol support]
a|
...
* ONTAP 9.10.1
a|
https://docs.netapp.com/us-en/sc-plugin-vmware-vsphere/scpivs44_create_backup_policies_for_vms_and_datastores.html[SnapMirror active sync support]
a|
...
a|
https://docs.netapp.com/us-en/sc-plugin-vmware-vsphere/scpivs44_deployment_planning_and_requirements.html#connection-and-port-requirements[SnapCenter Plug-in for VMware vSphere with vCenter Server]
a|

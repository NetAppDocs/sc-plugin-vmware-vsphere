...
. Select *Menu* and select the *Storage* menu option, then select a datastore, then select the *Configure* tab, and then select *Backups* in the *SnapCenter Plug-in for VMware vSphere* section.

...
+
For information about how administrators assign resources to users, see the https://docs.netapp.com/us-en/snapcenter/concept/concept_snapcenter_role_based_access_control_rbac.html[SnapCenter information on using role-based access control^].

...
+
For information about how administrators assign resources to users, see the http://docs.netapp.com/ocsc-44/index.jsp[SnapCenter information on using role-based access control^].

...
[NOTE]
When primary is online, restore from SnapMirror Business Continuity (SMBC) destination is not supported, It is recommended that you restore from the primary location.

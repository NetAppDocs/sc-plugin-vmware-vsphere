...
= Modify the network settings for the SnapCenter Plug-in for VMware vSphere
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
+
image:scpivs44_image31.png["SnapCenter Plug-in for VMware vSphere management user interface"]

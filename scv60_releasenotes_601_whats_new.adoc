...
a|
ONTAP tools for VMware vSphere 10.x helps to configure VMware vSphere Virtual Volumes. With this Intergration, you can configure, back up, and restore virtual machines residing on NFS-based vVols datastores.
|===

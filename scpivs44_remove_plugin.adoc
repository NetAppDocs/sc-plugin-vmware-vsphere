...
= Remove the SnapCenter Plug-in for VMware vSphere
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
. Log in to the SnapCenter Plug-in for VMware vSphere management user interface using the format `\https://<OVA-IP-address>:8080`.
+

...
. On the *Detach Virtual Disk* screen, select one or more disks you want to detach, then click the *Detach the selected disk(s)* button, and then click *DETACH*.
// Updated for BURT 1378132 observation 38 (Changed confirm to DETACH)
+
[IMPORTANT]

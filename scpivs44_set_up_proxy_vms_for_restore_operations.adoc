...
|===
+
The SnapCenter Plug-in for VMware vSphere uses the selected credentials to log into the selected proxy VM.
+
...
[NOTE]
You need to delete the proxy VM from the SnapCenter Plug-in for VMware vSphere UI before you can delete it from ESXi.

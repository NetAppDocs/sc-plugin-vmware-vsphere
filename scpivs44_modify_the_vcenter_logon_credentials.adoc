...
keywords: register SCV with vCenter, SCV vCenter registration, modify SCV credentials, update SCV vCenter credentials, vCenter logon credentials, SnapCenter Plug-in for VMware vSphere configuration
summary: 'Update the SCV credentials used to access vCenter. Complete this task after a vCenter credential change. For vVol backups, unregister and re-register ONTAP tools for VMware vSphere.'
---

= Update SCV credentials for vCenter access
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:

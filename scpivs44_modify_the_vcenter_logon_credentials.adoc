...
summary: 'Update the vCenter logon credentials configured in SCV. When the vCenter credential changes, update it in SCV so that vCenter remains registered with SCV.'
---

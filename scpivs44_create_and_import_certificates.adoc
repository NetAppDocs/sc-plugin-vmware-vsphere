...
= Create and import certificates for the SCV
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
Refer to https://kb.netapp.com/data-mgmt/SnapCenter/SC_KBs/How_to_create_and_or_import_an_SSL_certificate_to_SnapCenter_Plug-in_for_VMware_vSphere[KB article: How to create and/or import an SSL certificate to SnapCenter Plug-in for VMware vSphere] for more information.

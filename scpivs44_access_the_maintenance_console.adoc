...
+
Beginning in SnapCenter Plug-in for VMware vSphere 4.7, you must specify a password when you first install SnapCenter Plug-in for VMware vSphere 4.7. If you upgrade from release 4.6 or earlier to release 4.7 or later, the earlier default password is accepted.
